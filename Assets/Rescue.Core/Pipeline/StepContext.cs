...
namespace Rescue.Core.Pipeline
{
    internal sealed record StepContext(
        ...
        ImmutableArray<string> LatchedTargetIdsThisAction,
        ImmutableArray<string> ExtractedTargetIdsThisAction,
        ImmutableArray<FloodedRescuePath> FloodedRescuePathsThisAction,
        ...
        bool IsWin)
    {
        public static StepContext Create(GameState state, ActionInput input)
        {
            ...
            return new StepContext(
                ...
                LatchedTargetIdsThisAction: ImmutableArray<string>.Empty,
                ExtractedTargetIdsThisAction: ImmutableArray<string>.Empty,
                FloodedRescuePathsThisAction: ImmutableArray<FloodedRescuePath>.Empty,
