...
namespace Rescue.Unity.Water.Tests
{
    public sealed class WaterViewPresenterTests
    {
        ...
        private static GameState CreateState(int width, int height, int floodedRows)
        {
            ...
            return new GameState(
                ...
                Water: new WaterState(FloodedRows: floodedRows, ActionsUntilRise: 3, RiseInterval: 5),
