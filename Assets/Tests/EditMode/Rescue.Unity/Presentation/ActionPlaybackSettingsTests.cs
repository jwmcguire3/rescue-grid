...
namespace Rescue.Unity.Presentation.Tests
{
    public sealed class ActionPlaybackSettingsTests
    {
        ...
        public void ActionPlaybackSettings_ExposesCentralizedDurations()
        {
            ...
            Assert.That(settings.DockWarningFullDurationSeconds, Is.GreaterThan(0f));
        ...
        public void ActionPlaybackSettings_DefaultsStayWithinIntendedRanges()
        {
            ...
            Assert.That(settings.DockWarningFullDurationSeconds, Is.EqualTo(settings.DockWarningAcuteDurationSeconds * ActionPlaybackSettings.DockWarningFullDurationMultiplier));
            ...
            Assert.That(settings.DockClearFeedbackDurationSeconds, Is.InRange(0.34f, 0.38f));
