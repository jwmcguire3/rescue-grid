...
namespace Rescue.LevelTelemetryTool
{
    ...
    internal static class LevelTelemetryRunner
    {
        ...
        private static void ValidateRange(string range)
        {
            ...
            if (parts.Length != 2)
            {
                throw new ArgumentException("--range must use the form L00-L28.");
            }
        ...
        private static void PrintUsage()
        {
            ...
            Console.Error.WriteLine("  dotnet run --project Tools/LevelTelemetry/LevelTelemetry.csproj -- --range L00-L28 [--samples 200] [--max-actions 30] [--output Reports/LevelTelemetry]");
        }
